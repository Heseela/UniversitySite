...
export const siteSettingSchema = z.object({
    logoLight_primary: mediaSchema.nullish(),
    logoDark_primary: mediaSchema.nullish(),
    logoLight_secondary: mediaSchema.nullish(),
    logoDark_secondary: mediaSchema.nullish(),
